...
| 2 | DeepONet理论 | 学习DeepONet，了解**Operator Learning** | 1. 读论文[DeepONet](https://arxiv.org/abs/1910.03193)<br>2. 撰写`.md`回答以下问题：<br>• **相比PINN，算子的本质区别与优势**<br>• branch net和trunk net各自的作用<br>• **数据生成方式(GRF)**<br>• 你认为DeepONet求解PDE可提升之处<br>•**神经算子(NO)和神经网络(NN)的区别** | 2025/10/5 |
